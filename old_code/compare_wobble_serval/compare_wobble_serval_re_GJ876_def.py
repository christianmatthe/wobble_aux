...
pp =PdfPages("wobble_servalcomparison_GJ876_"+kt+".pdf")
...
for i in objects:
    ...
    #HACK scale is obviously not the proper correction:
    scale =1.0
    ser_rvc = ser_rvc[indices_serval]
    ser_addinfo = ser_addinfo[indices_serval]
    w_dates = w_dates[indices_wobble]
    w_RVs_barycorr =scale * w_RVs_barycorr[indices_wobble]
    w_RVs_barycorr_ivar = scale * w_RVs_barycorr_ivar[indices_wobble]
