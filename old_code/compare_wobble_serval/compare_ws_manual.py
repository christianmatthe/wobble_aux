...
#####
loop = 4
data_file = "/data/cmatthe/wobble_reg_search/GJ436_test_run_0.1/loop_{0}/results_t_L2_template_-1/results_GJ436_Kstar0_Kt3_reg_search_test.hdf5".format(loop)
recalculate_baryQ = True #TODO reimplement pickle saving of barycorrected RVs
kt = 'Kt3_loop{0}_t_L2_template_-1'.format(loop) # HACK missuse this to label different  loops in pickle
#kt='Kt3_order_39_test'
#kt='Kt3_opt3'
pp =PdfPages("wsc_GJ436_reg_search_loop_{0}".format(loop) +".pdf")
...
for i in objects:
    ...
    if i[2]=="vis":
        ...
        wobble_res_lx39 = h5py.File(data_file,'r')
...
# =============================================================================
    ...
    if 'orbital_parameters' in locals():
        ...
        ax1.plot(np.absolute(w_RVs_original_barycorr - np.nanmean(w_RVs_original_barycorr) - fit_func(w_dates, T0_offset)), w_RVs_er,"x", label = "wobble_corr")
