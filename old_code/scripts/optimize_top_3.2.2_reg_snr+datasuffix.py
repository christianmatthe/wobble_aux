...
#NOTE change 25/10/2019 snr+data_suffix: epochs_list now gernerated in reg_grad_orderwise
...
epochs_list = parameters.dictionary["epochs_list"]
...
for i in range(len(chunks)):
    ...
    #NOTE change 25/10/2019 snr+data_suffix
    os.system("python3 optimize_chunk_3.2.2_reg_snr+datasuffix.py")
