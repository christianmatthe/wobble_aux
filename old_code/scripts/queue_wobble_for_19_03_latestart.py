...
#NOTE For Presentation: All originally performed on order 6 continuum Normalization
#latestarts
parameters = Parameters(starname = "GJ1148", defaultQ = False,
                        ...
                        chunk_size = 5,
                        niter = 160,
                        reg_file_star =  "/data/cmatthe/wobble_data/wobble/regularization/GJ1148_star_K0_orders[11,53)_stitched_reformatted.hdf5",
                        reg_file_t = "/data/cmatthe/wobble_data/wobble/regularization/GJ1148_t_K3_orders[11,53)_stitched_reformatted.hdf5",
                        output_suffix = 'pres:GJ1148_wob_reg')
...
parameters.dictionary.update({"script" : "optimize_top_3.1.3_data_suffix.py"})
all_parameters.append(parameters.dictionary)
