...
if __name__ == "__main__":
    ...
    ############################
    run_name = "only_t_L2_template"#check where this  is used
    ...
    reg_types = ["t"] #t for tellurics NOTE(DO NOT CHANGE THIS NOMENCLATURE IT IS HARD CODED LATER ON)HACK
    #############################
    ...
    for i in range(max_loop_iterations):
        ...
        for j,typ in enumerate(reg_types):
            ...
            if typ == "t": # t= tellurics
                parameter_key_list = ["L2_template"]
