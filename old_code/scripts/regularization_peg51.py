...
if __name__ == "__main__":
    ...
    R = len(orders)
    star_filename = '../wobble/regularization/{0}_star_K{1}_self.hdf5'.format(starname, K_star)
    ...
    tellurics_filename = '../wobble/regularization/{0}_t_K{1}.hdf5_self'.format(starname, K_t)
