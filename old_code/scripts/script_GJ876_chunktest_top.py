...
n_orders = end - start
chunk_size = 21 #use at least 2 so median is not out of bounds
...
for i in range(len(chunks)):
    ...
    os.system("python3 script_GJ876_Chunktest.py {0} {1} {2} {3} {4} \"{5}\"".format(start_order, end_order, starname, K_star, K_t, epochs_list_str)) # TODO make this name context dependent/ work for any star params
...
results_file = results_file_base + '_stitched'+'.hdf5'
