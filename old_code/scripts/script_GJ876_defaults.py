...
if __name__ == "__main__":
    ...
    data = wobble.Data(starname+'_vis'+'_e2ds.hdf5', filepath='../data/', orders=orders, min_flux=10**-5)
    results = wobble.Results(data=data)
    ...
    results_file = '../results/results_{0}_Kstar{1}_Kt{2}_re1.hdf5'.format(starname, K_star, K_t)
