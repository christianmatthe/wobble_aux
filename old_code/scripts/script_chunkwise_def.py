...
if True:
    ...
    plot_dir = '../results/plots_{0}_Kstar{1}_Kt{2}_def_oldscript/'.format(starname, K_star, K_t)
    ...
    for r,o in enumerate(orders):
        ...
        #addition 12june2019
        with open("/data/cmatthe/wobble_data/scripts/yaml_temp/reg_par.txt","a") as f:
            lst=[]
