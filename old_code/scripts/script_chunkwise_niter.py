...
if True:
    ...
    if not defaultQ:
        ...
        plot_dir = '../results/plots_{0}_Kstar{1}_Kt{2}_n{3}/'.format(starname, K_star, K_t, niter)
        results_file = '../results/results_{0}_Kstar{1}_Kt{2}_n{5}_orders[{3},{4}).hdf5'.format(starname, K_star, K_t, start_order, end_order, niter)
    else:
