...
#NOTE Deprecated use script_chunkwise_top_lx32.py 10.04.19
#################### parameters
...
#put _def into results_file_base
results_file_base = '../results/results_{0}_Kstar{1}_Kt{2}'.format(starname, K_star, K_t)

results_file = results_file_base + '_oldscript2' + defaultQ + '.hdf5'
...
for i in range(len(chunks)):
    ...
    os.system("python3 script_chunkwise"+defaultQ+".py {0} {1} {2} {3} {4} \"{5}\"".format(start_order, end_order, starname, K_star, K_t, epochs_list_str)) # TODO make this name context dependent/ work for any star params
